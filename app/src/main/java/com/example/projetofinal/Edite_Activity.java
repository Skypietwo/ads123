...
public class Edite_Activity extends AppCompatActivity {
    ...
    EditText eId, eCpf_cli, eCod_espec, eCod_prof, eCod_proced, eData_proced, eDescr_proced, eLink_proced, eAut_vis_cli;
    private int posicao;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eId.setText(MainActivity4.listaFuncionarios.get(posicao).getId());
        eCpf_cli.setText(MainActivity4.listaFuncionarios.get(posicao).getCpf_cli());
        eCod_espec.setText(MainActivity4.listaFuncionarios.get(posicao).getCod_espec());
        eCod_prof.setText(MainActivity4.listaFuncionarios.get(posicao).getCod_prof());
        eCod_proced.setText(MainActivity4.listaFuncionarios.get(posicao).getCod_proced());
        eData_proced.setText(MainActivity4.listaFuncionarios.get(posicao).getData_proced());
        eDescr_proced.setText(MainActivity4.listaFuncionarios.get(posicao).getDescr_proced());
        eLink_proced.setText(MainActivity4.listaFuncionarios.get(posicao).getLink_proced());
        eAut_vis_cli.setText(MainActivity4.listaFuncionarios.get(posicao).getAut_vis_cli());
    }
    ...
    public void btn_updateData(View view) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.251.35/treze/pro_update.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Toast.makeText(Edite_Activity.this, response, Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Edite_Activity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Edite_Activity.this);
